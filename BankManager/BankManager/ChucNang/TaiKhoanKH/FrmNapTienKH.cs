...
{
    public partial class FrmNapTienKH : Form
    {
        ...
        private void NguyenHongKhang_07_btnNap_Click(object sender, EventArgs e)
        {
            if (string.IsNullOrWhiteSpace(NguyenHongKhang_07_txtSTK.Text) || string.IsNullOrWhiteSpace(NguyenHongKhang_07_txtTien.Text))
                ...
                if (tk == null)
                    ...
                    MessageBox.Show(string.Format("Bạn đã nạp {0}VNĐ vào tài khoản {1}", NguyenHongKhang_07_txtTien.Text, NguyenHongKhang_07_txtSTK.Text));
                    chuyenTrang();
                }
            }
        }
